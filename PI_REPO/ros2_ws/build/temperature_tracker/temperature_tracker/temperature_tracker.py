#   Hentet fra https://github.com/Infinite-Echo/ros2_temperature_tracker/commit/999142b68f241ca0b7b7e9cb8e0f017f54e8c460
#   Dato: 25.10.2025
        ...
        for i in range(10):
            ...
            if exists(type_path):
                with open(type_path, 'r') as f:
                    ...
                    if 'cpu' in zone_name or 'bcm' in zone_name:
                        self.get_logger().info(f"Detected CPU zone: {zone_name} (zone {i})")
                        return i
